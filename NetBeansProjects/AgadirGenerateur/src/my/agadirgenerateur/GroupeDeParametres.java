 ...
 * @author fkakcha
 */
public class GroupeDeParametres extends javax.swing.JFrame {

    /**
     * Creates new form GroupeDeParamretres
     */
    public GroupeDeParametres() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GroupeDeParametres.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GroupeDeParametres().setVisible(true);
            }
        });
    }
