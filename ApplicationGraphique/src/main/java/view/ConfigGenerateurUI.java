...
/**
 * Cette classe définit l'UI utilisée pour configurer les paramètres du générateur
 */

public class ConfigGenerateurUI extends JDialog{
    ...
    private void initComponents() {
        ...
        setTitle("Configurations du générateur");
    ...
    public void addJButton13Listener(ActionListener action){
    	jButton13.setActionCommand("Enregistrer config generateur");
    	jButton13.addActionListener(action);
    }
    
    public void addJButton14Listener(ActionListener action){
    	jButton14.setActionCommand("Annuler config generateur");
