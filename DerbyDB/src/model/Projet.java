...
public class Projet {
	...
	public void toPrint(){
		...
		logger.info("Description du " + toString());
		
		if(listGroupeParam.isEmpty()){
			
			System.out.print("-------------- Groupe de paramètres: Aucuns groupes de paramètres pour ce projet");
		}
		else{
			...
			for(GroupeParametre grpeParam : listGroupeParam.values()){
				...
				System.out.print("-------------- Groupe de paramètres "+ i +" : ");
				grpeParam.toPrint();
				i++;
			}				
		}							
		...
		if(listModele.isEmpty()){
			...
			System.out.println("Aucuns modèles pour ce projet");
		}			
		else{
